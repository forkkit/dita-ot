...
public final class Constants {
    ...
    public static final DitaClass EQUATION_D_EQUATION_BLOCK = new DitaClass("+ topic/div equation-d/equation-block ");
    public static final DitaClass EQUATION_D_EQUATION_FIGURE = new DitaClass("+ topic/fig equation-d/equation-figure ");
    public static final DitaClass EQUATION_D_EQUATION_INLINE = new DitaClass("+ topic/ph equation-d/equation-inline ");
    public static final DitaClass EQUATION_D_EQUATION_NUMBER = new DitaClass("+ topic/ph equation-d/equation-number ");
    ...
    public static final DitaClass HI_D_LINE_THROUGH = new DitaClass("+ topic/ph hi-d/line-through ");
    public static final DitaClass HI_D_OVERLINE = new DitaClass("+ topic/ph hi-d/overline ");
    ...
    public static final DitaClass LEARNING2_D_LCANSWERCONTENT2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcAnswerContent2 ");
    public static final DitaClass LEARNING2_D_LCANSWEROPTION2 = new DitaClass("+ topic/li learningInteractionBase2-d/li learning2-d/lcAnswerOption2 ");
    public static final DitaClass LEARNING2_D_LCANSWEROPTIONGROUP2 = new DitaClass("+ topic/ul learningInteractionBase2-d/ul learning2-d/lcAnswerOptionGroup2 ");
    public static final DitaClass LEARNING2_D_LCAREA2 = new DitaClass("+ topic/figgroup learningInteractionBase2-d/figgroup learning2-d/lcArea2 ");
    public static final DitaClass LEARNING2_D_LCAREACOORDS2 = new DitaClass("+ topic/ph learningInteractionBase2-d/ph learning2-d/lcAreaCoords2 ");
    public static final DitaClass LEARNING2_D_LCAREASHAPE2 = new DitaClass("+ topic/keyword learningInteractionBase2-d/keyword learning2-d/lcAreaShape2 ");
    public static final DitaClass LEARNING2_D_LCASSET2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcAsset2 ");
    public static final DitaClass LEARNING2_D_LCCORRECTRESPONSE2 = new DitaClass("+ topic/data learningInteractionBase2-d/data learning2-d/lcCorrectResponse2 ");
    public static final DitaClass LEARNING2_D_LCFEEDBACK2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedback2 ");
    public static final DitaClass LEARNING2_D_LCFEEDBACKCORRECT2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedbackCorrect2 ");
    public static final DitaClass LEARNING2_D_LCFEEDBACKINCORRECT2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcFeedbackIncorrect2 ");
    public static final DitaClass LEARNING2_D_LCHOTSPOT2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcHotspot2 ");
    public static final DitaClass LEARNING2_D_LCHOTSPOTMAP2 = new DitaClass("+ topic/fig learningInteractionBase2-d/figgroup learning2-d/lcHotspotMap2 ");
    public static final DitaClass LEARNING2_D_LCINSTRUCTORNOTE2 = new DitaClass("+ topic/note learningInteractionBase2-d/note learning2-d/lcInstructornote2 ");
    public static final DitaClass LEARNING2_D_LCITEM2 = new DitaClass("+ topic/stentry learningInteractionBase2-d/stentry learning2-d/lcItem2 ");
    public static final DitaClass LEARNING2_D_LCMATCHING2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcMatching2 ");
    public static final DitaClass LEARNING2_D_LCMATCHINGHEADER2 = new DitaClass("+ topic/sthead learningInteractionBase2-d/sthead learning2-d/lcMatchingHeader2 ");
    public static final DitaClass LEARNING2_D_LCMATCHINGITEM2 = new DitaClass("+ topic/stentry learningInteractionBase2-d/stentry learning2-d/lcMatchingItem2 ");
    public static final DitaClass LEARNING2_D_LCMATCHINGITEMFEEDBACK2 = new DitaClass("+ topic/stentry learningInteractionBase2-d/stentry learning2-d/lcMatchingItemFeedback2 ");
    public static final DitaClass LEARNING2_D_LCMATCHINGPAIR2 = new DitaClass("+ topic/strow learningInteractionBase2-d/strow learning2-d/lcMatchingPair2 ");
    public static final DitaClass LEARNING2_D_LCMATCHTABLE2 = new DitaClass("+ topic/simpletable learningInteractionBase2-d/simpletable learning2-d/lcMatchTable2 ");
    public static final DitaClass LEARNING2_D_LCMULTIPLESELECT2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcMultipleSelect2 ");
    public static final DitaClass LEARNING2_D_LCOPENANSWER2 = new DitaClass("+ topic/div learningInteractionBase2-d/div learning2-d/lcOpenAnswer2 ");
    public static final DitaClass LEARNING2_D_LCOPENQUESTION2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcOpenQuestion2 ");
    public static final DitaClass LEARNING2_D_LCQUESTION2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcQuestionBase2 learning2-d/lcQuestion2 ");
    public static final DitaClass LEARNING2_D_LCSEQUENCE2 = new DitaClass("+ topic/data learningInteractionBase2-d/data learning2-d/lcSequence2 ");
    public static final DitaClass LEARNING2_D_LCSEQUENCEOPTION2 = new DitaClass("+ topic/li learningInteractionBase2-d/li learning2-d/lcSequenceOption2 ");
    public static final DitaClass LEARNING2_D_LCSEQUENCEOPTIONGROUP2 = new DitaClass("+ topic/ol learningInteractionBase2-d/ol learning2-d/lcSequenceOptionGroup2 ");
    public static final DitaClass LEARNING2_D_LCSEQUENCING2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcSequencing2 ");
    public static final DitaClass LEARNING2_D_LCSINGLESELECT2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcSingleSelect2 ");
    public static final DitaClass LEARNING2_D_LCTRUEFALSE2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 learning2-d/lcTrueFalse2 ");
    ...
    public static final DitaClass LEARNINGGROUPMAP_LEARNINGGROUPMAP = new DitaClass("- map/map learningGroupMap/learningGroupMap ");
    ...
    public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCINTERACTIONBASE2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcInteractionBase2 ");
    public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCINTERACTIONLABEL2 = new DitaClass("+ topic/p learningInteractionBase2-d/lcInteractionLabel2 ");
    public static final DitaClass LEARNINGINTERACTIONBASE2_D_LCQUESTIONBASE2 = new DitaClass("+ topic/div learningInteractionBase2-d/lcQuestionBase2 ");
    ...
    public static final DitaClass LEARNINGMAP_D_LEARNINGGROUPMAPREF = new DitaClass("+ map/topicref learningmap-d/learningGroupMapRef ");
    public static final DitaClass LEARNINGMAP_D_LEARNINGOBJECT = new DitaClass("+ map/topicref learningmap-d/learningObject ");
    public static final DitaClass LEARNINGMAP_D_LEARNINGOBJECTMAPREF = new DitaClass("+ map/topicref learningmap-d/learningObjectMapRef ");
    ...
    public static final DitaClass LEARNINGOBJECTMAP_LEARNINGOBJECTMAP = new DitaClass("- map/map learningObjectMap/learningObjectMap ");
    ...
    public static final DitaClass MAP_UX_WINDOW = new DitaClass("- map/ux-window ");
    ...
    public static final DitaClass MARKUP_D_MARKUPNAME = new DitaClass("+ topic/keyword markup-d/markupname ");
    public static final DitaClass MATHML_D_MATHML = new DitaClass("+ topic/foreign mathml-d/mathml ");
    public static final DitaClass MATHML_D_MATHMLREF = new DitaClass("+ topic/xref mathml-d/mathmlref ");
    ...
    public static final DitaClass RELMGMT_D_CHANGE_COMPLETED = new DitaClass("+ topic/data relmgmt-d/change-completed ");
    public static final DitaClass RELMGMT_D_CHANGE_HISTORYLIST = new DitaClass("+ topic/metadata relmgmt-d/change-historylist ");
    public static final DitaClass RELMGMT_D_CHANGE_ITEM = new DitaClass("+ topic/data relmgmt-d/change-item ");
    public static final DitaClass RELMGMT_D_CHANGE_ORGANIZATION = new DitaClass("+ topic/data relmgmt-d/change-organization ");
    public static final DitaClass RELMGMT_D_CHANGE_PERSON = new DitaClass("+ topic/data relmgmt-d/change-person ");
    public static final DitaClass RELMGMT_D_CHANGE_REQUEST_ID = new DitaClass("+ topic/data relmgmt-d/change-request-id ");
    public static final DitaClass RELMGMT_D_CHANGE_REQUEST_REFERENCE = new DitaClass("+ topic/data relmgmt-d/change-request-reference ");
    public static final DitaClass RELMGMT_D_CHANGE_REQUEST_SYSTEM = new DitaClass("+ topic/data relmgmt-d/change-request-system ");
    public static final DitaClass RELMGMT_D_CHANGE_REVISIONID = new DitaClass("+ topic/data relmgmt-d/change-revisionid ");
    public static final DitaClass RELMGMT_D_CHANGE_STARTED = new DitaClass("+ topic/data relmgmt-d/change-started ");
    public static final DitaClass RELMGMT_D_CHANGE_SUMMARY = new DitaClass("+ topic/data relmgmt-d/change-summary ");
    ...
    public static final DitaClass TASK_STEPTROUBLESHOOTING = new DitaClass("- topic/itemgroup task/steptroubleshooting ");
    ...
    public static final DitaClass TASK_TASKTROUBLESHOOTING = new DitaClass("- topic/section task/tasktroubleshooting ");
    ...
    public static final DitaClass TASKREQ_D_REQCONDS = new DitaClass("+ topic/ul task/ul taskreq-d/reqconds ");
    public static final DitaClass TASKREQ_D_REQCONTP = new DitaClass("+ topic/li task/li taskreq-d/reqcontp ");
    public static final DitaClass TASKREQ_D_REQPERS = new DitaClass("+ topic/ul task/ul taskreq-d/reqpers ");
    ...
    public static final DitaClass TOPIC_DIV = new DitaClass("- topic/div ");
    ...
    public static final DitaClass TROUBLESHOOTING_CAUSE = new DitaClass("- topic/section troubleshooting/cause ");
    public static final DitaClass TROUBLESHOOTING_CONDITION = new DitaClass("- topic/section troubleshooting/condition ");
    public static final DitaClass TROUBLESHOOTING_REMEDY = new DitaClass("- topic/section troubleshooting/remedy ");
    public static final DitaClass TROUBLESHOOTING_RESPONSIBLEPARTY = new DitaClass("- topic/p troubleshooting/responsibleParty ");
    public static final DitaClass TROUBLESHOOTING_TROUBLEBODY = new DitaClass("- topic/body troubleshooting/troublebody ");
    public static final DitaClass TROUBLESHOOTING_TROUBLESHOOTING = new DitaClass("- topic/topic troubleshooting/troubleshooting ");
    public static final DitaClass TROUBLESHOOTING_TROUBLESOLUTION = new DitaClass("- topic/bodydiv troubleshooting/troubleSolution ");
    ...
    public static final DitaClass UT_D_SORT_AS = new DitaClass("+ topic/data ut-d/sort-as ");
    public static final DitaClass XML_D_NUMCHARREF = new DitaClass("+ topic/keyword markup-d/markupname xml-d/numcharref ");
    public static final DitaClass XML_D_PARAMETERENTITY = new DitaClass("+ topic/keyword markup-d/markupname xml-d/parameterentity ");
    public static final DitaClass XML_D_TEXTENTITY = new DitaClass("+ topic/keyword markup-d/markupname xml-d/textentity ");
    public static final DitaClass XML_D_XMLATT = new DitaClass("+ topic/keyword markup-d/markupname xml-d/xmlatt ");
    public static final DitaClass XML_D_XMLELEMENT = new DitaClass("+ topic/keyword markup-d/markupname xml-d/xmlelement ");
    public static final DitaClass XML_D_XMLNSNAME = new DitaClass("+ topic/keyword markup-d/markupname xml-d/xmlnsname ");
    public static final DitaClass XML_D_XMLPI = new DitaClass("+ topic/keyword markup-d/markupname xml-d/xmlpi ");
